...
function global_UI()
	...
	UI:CheckBoxGroup(global_basic_page, "sg_en","超鬼王[全功能 - 详细说明见第3设置页面]","0",30,"0,0,0","20,140,960,60")
	...
	UI:ComboBox(global_super_ghost_page, "sg_force", ">= 1星,>= 2星,>= 3星,>= 4星,>= 5星,       6星,不开启","4",23,"600,20,380,50")
	UI:Label(global_super_ghost_page, "left", "0,0,0", 30, "战斗标记 - ", "20,80,300,60")
	UI:CheckBoxGroup(global_super_ghost_page, "sg_mark", "Boss      ,草人","2",30,"0,0,0","600,80,400,60")
	UI:Label(global_super_ghost_page, "left", "0,0,0", 30, "战斗疲劳[6星] - ", "20,140,300,60")
	UI:ComboBox(global_super_ghost_page, "sg_action_6", "集结,等待,喝茶","2",23,"600,140,380,50")
	UI:Label(global_super_ghost_page, "left", "0,0,0", 30, "战斗疲劳[5星] - ", "20,200,300,60")
	UI:ComboBox(global_super_ghost_page, "sg_action_5", "集结,等待,喝茶","2",23,"600,200,380,50")
